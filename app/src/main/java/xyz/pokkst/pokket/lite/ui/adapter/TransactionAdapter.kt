package xyz.pokkst.pokket.lite.ui.adapter
...
import xyz.pokkst.pokket.lite.util.DateFormatter
...
class TransactionAdapter(private val dataSet: List<Transaction>) :
    ...
    class NftAdapter(itemView: View, private val listener: TxAdapterListener?) :
